...
GCC_BIN = 
PROJECT = availability-aware-mbed-usb-power-measurement
OBJECTS = ./main.o ./UtilityLib/SerialManager.o ./UtilityLib/util.o ./SensorsLib/I2CSensor.o ./SensorsLib/PeriodicSensor.o ./SensorsLib/INA219.o ./SensorsLib/SleepableSensor.o 
